    ...
    methods
        ...
        function init(this, Q,R, st0, cov0)
           ...
           % this.nMGPS  = nMGPS;  % How many h-functions do we get
            ...
            this.nSt = 7;       % Nr of states in statevector             
            this.nSP = 1 + 2*7; % Nr of sigma points to use in filter 
